...
<a href="/?v=messages&from_id=<?=$row['to_id']?>">
<div class="row">
<div class="profile_thumb" style="display:inline-block;background:url(/files/<?=userUser($row['to_id'])?>.jpg)no-repeat center center; background-size: cover;border:none;float:left;margin: 15px 10px 0 0"></div>
